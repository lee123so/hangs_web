<template>
  <div class="admin_inner">
    <div class="history_title">서비스관리 > 신청내역</div>
    <form >
      <div class="form_container">
        ...
        <div class="form_wrap">
          ...
          <CommSelect :options="service_config.service_options" v-model="search_input.service_plan_id" :select_label="'서비스종류'"/>
    ...
    <CommTable
        ...
        :data_name="'admin_users_service_info'"
        :columns="columns"
        :router_link="'/service/permit/'"
        :button="true"
        :header-labels="tableHeaderLabels"
    ><span>신청승인</span></CommTable>
  </div>
...
export default {
  ...
  setup() {
    ...
    return {searchHandler,service_config,search_input,config, columns, tableHeaderLabels}
  }
}
</script>
